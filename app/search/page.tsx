      ...
      <div className="mt-10 max-w-4xl mx-auto">
        ...
        {results && !isLoading && !error && (
          <div className="bg-white shadow-md rounded p-6 border border-gray-200 relative">
            ...
            <div className="flex justify-between items-start">
              ...
              {cacheStatus && (
                <span
                  className={`text-xs font-medium px-5 py-0.5 rounded ${
                    cacheStatus === 'hit'
            ...
            <pre className="bg-gray-100 p-4 rounded overflow-x-auto text-sm border mt-2">
              {' '}
              {/* Added mt-2 */}
        ...
        {!isLoading && !error && !results && (
          <p className="text-center text-gray-500 pt-4">
            {searchTerm
              ? 'No results found.'
              : 'Enter an IP or domain to search.'}
          </p>
        )}
      </div>
    </div>
